...
InvertPixel8(
	...
	PF_Pixel 	*out)
{
	register SmartyPantsDataPlus	*idp = (SmartyPantsDataPlus*)refcon;
	register SmartyPantsData		*id = idp->id;
	A_long					i;
...
InvertPixelFloat(
	...
	PF_PixelFloat 	*out)
{
	register SmartyPantsDataPlus	*idp 	= reinterpret_cast<SmartyPantsDataPlus*>(refcon);
	register SmartyPantsData		*id		= idp->id;
