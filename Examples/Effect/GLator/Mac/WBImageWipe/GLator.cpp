	...
	PF_SmartRenderExtra		*extra)
{
    ...
    PF_FpLong          checkBox = 0;
    PF_ParamValue       type = 0;
	...
	if (!err){
        ...
        checkBox = checkBox_param.u.bd.value;
	}
...
//			RenderGL(renderContext, widthL, heightL, inputFrameTexture, sliderVal, multiplier16bit);
            RenderGL(renderContext, widthL, heightL, inputFrameTexture, sliderVal, multiplier16bit, checkBox, type);
